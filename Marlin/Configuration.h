...
#define STRING_CONFIG_H_AUTHOR "(ljubizki, TMC2130)" // Who made the changes.
...
#define STEPS_FACTOR_A4988 1
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 76.20*STEPS_FACTOR, 88.88*STEPS_FACTOR, 3200*STEPS_FACTOR_A4988, 130*STEPS_FACTOR_A4988}
